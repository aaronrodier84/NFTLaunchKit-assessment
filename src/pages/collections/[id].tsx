...
import CollectionDetailSkeleton from "lib/components/skeletons/CollectionDetailSkeleton";
...
const CollectionDetail: NextPage = () => {
  ...
  const [metadata, setMetadata] = useState<ICollectionMetadata>(
    initCollectionMetadata
  );
  ...
  return (
    <Layout>
      <Flex minH="80%" flexDirection={"column"} gap={8}>
        <Container maxW={"5xl"} py={12}>
          {collection?.token_id === "" && <CollectionDetailSkeleton />}
          {collection?.token_id !== "" && (
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
              ...
              <Stack spacing={5}>
                ...
                >
                  <Text fontSize={"md"} color={titleColor} fontWeight={"600"}>
                    Details
                  </Text>
                  <List spacing={2}>
                    <ListItem>
                      <Flex
                        ...
                        fontWeight={300}
                      >
                        <Text as={"span"}>Contract Address</Text>
                        <Link
                          _hover={{
                            textDecoration: "none",
                          }}
                    ...
                    <ListItem>
                      ...
                      >
                        ...
                        <Text as={"span"}>
                          {formatDateFromNow(collection.last_metadata_sync)}
                        </Text>
                      </Flex>
                    </ListItem>
                  </List>
